...
@Entity
@Table(name="etapas")
public class Etepa implements Serializable{
	/**
	 * 
	 */
	
	/*
	 * Modificar base de datos de etapa
	 * Cambiar el nombre de la clase
	 * Agregar:	id_seguimiento
	 * 			id_tarea
	 * bidireccionalidad de esos dos desde el codigo 
	 * 
	 * */
